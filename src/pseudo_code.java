...
/**
 * This is pseudo code for the main method of a simple grade center.
 * @author CAIRD
 */
public class pseudo_code {
     //call method getGrade and store the returned double as grade1;
     //call method getGrade and store the returned double as grade2;
     //call method getGrade and store the returned double as grade3;
     //call method getGrade and store the returned double as grade4;
     //call method getGrade and store the returned double as grade5;
